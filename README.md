...
2014-03 New class for Alarm handling. Support for ThingSpeak client
(channel update and TalkBack API). Improving the ADXL345 accelerometer
device driver and example sketch. Adding a Soft SPI implementation
(only 0/2 mode).        

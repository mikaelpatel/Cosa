/**
 * @file Cosa/Board/Microduino/Core.hh
 * @version 1.0
 *
 * @section License
...
#ifndef COSA_BOARD_MICRODUINO_CORE_HH
#define COSA_BOARD_MICRODUINO_CORE_HH
 ...
 *
 * @section References
 * 1. http://www.microduino.cc/wiki/images/4/4a/Microduino-Core-Pinout.jpg
 */
class Board {
  friend class Pin;
  friend class UART;

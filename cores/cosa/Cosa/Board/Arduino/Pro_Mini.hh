/**
 * @file Cosa/Board/Arduino/Pro_Mini.hh
 * @version 1.0
 *
 * @section License
...
#ifndef COSA_BOARD_ARDUINO_PRO_MINI_HH
#define COSA_BOARD_ARDUINO_PRO_MINI_HH
 ...
 * board Arduino Pro Mini. Cosa does not use pin numbers as

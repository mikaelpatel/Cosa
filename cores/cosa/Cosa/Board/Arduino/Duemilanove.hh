/**
 * @file Cosa/Board/Arduino/Duemilanove.hh
 * @version 1.0
 *
 * @section License
...
#ifndef COSA_BOARD_ARDUINO_DUEMILANOVE_HH
#define COSA_BOARD_ARDUINO_DUEMILANOVE_HH
 ...
 * board Arduino Duemilanove. Cosa does not use pin numbers as

/**
 * @file Cosa/Wireless/Driver/VWI/Codec/VirtualWireCodec.hh
 * @version 1.0
 *
 * @section License
...
#ifndef __COSA_WIRELESS_DRIVER_VWI_CODEC_VIRTUALWIRECODEC_HH__
#define __COSA_WIRELESS_DRIVER_VWI_CODEC_VIRTUALWIRECODEC_HH__
